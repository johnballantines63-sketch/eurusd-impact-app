#!/usr/bin/env python3
"""
Analyse Complète 2025-09-11
===========================

Objectif : Extraire tous les détails pour 2025-09-11 (pic1, pullback, pic2, timings, cours, pips)
"""
...
print('='*100)
print(f'ANALYSE COMPLÈTE - {date_str}')
print('='*100)
print()
...
if anchor_time:
    ...
    if not df_prices.empty:
        ...
        # PIC 1 (Wave1)
        if wave1_time:
            # Trouver le cours le plus proche
            ...
            if closest_idx >= 0:
                ...
                if baseline_price and baseline_price > 0:
                    ...
                    wave1_pips_high = (wave1_high - first_price) * 10000
                    wave1_pips_low = (wave1_low - first_price) * 10000
                    wave1_pips_close = (wave1_close - first_price) * 10000
        ...
        if pullback_time:
            ...
            if closest_idx >= 0:
                ...
                if baseline_price and baseline_price > 0:
                    ...
                    first_price = df_prices.iloc[0]['close']
                    pullback_pips_high = (pullback_high - first_price) * 10000
                    pullback_pips_low = (pullback_low - first_price) * 10000
                    pullback_pips_close = (pullback_close - first_price) * 10000
        ...
        if wave2_time:
            ...
            if closest_idx >= 0:
                ...
                if baseline_price and baseline_price > 0:
                    ...
                    first_price = df_prices.iloc[0]['close']
                    wave2_pips_high = (wave2_high - first_price) * 10000
                    wave2_pips_low = (wave2_low - first_price) * 10000
                    wave2_pips_close = (wave2_close - first_price) * 10000
                ...
                print(f'  Pips absolus (pattern) : {wave2_peak_pips_absolute:.2f} pips')
                print()
...
if wave1_time and pullback_time and wave2_time:
