#!/usr/bin/env python3
"""
SESSION 106 - PHASE 1 : VALIDATION CLUSTER #3 - RÈGLE SESSION 92.10
=====================================================================

RÈGLE TIMEZONE CORRECTE (Session 92.10) :
- Event à 14:30 Bern → Chercher à 12:30:00+02:00 dans DB
- Soustraire 2h à l'heure Bern pour obtenir l'heure DB
- Prix référence = LOW de la première bougie event

Validation Session 99 :
- 11.09.2025 : ~57 pips (LOW first candle = 1.16680)
...
print("="*80)
print("SESSION 106 - PHASE 1 : VALIDATION CLUSTER #3 - RÈGLE SESSION 92.10")
print("="*80)
print()
...
EXPECTED_IMPACT_REFERENCE = 57.0  # Session 99 validé
...
def measure_real_impact_SESSION9210(event_timestamp_db: str, date_str: str) -> dict:
    """
    Mesure impact réel - RÈGLE SESSION 92.10
    
    CRITIQUE :
    - Event à 14:30 Bern → Chercher à 12:30:00+02:00 dans DB
    - Soustraire 2h à l'heure Bern pour query
    - Prix référence = LOW première bougie event
    
    Validation Session 99 :
    - 11.09.2025 : ~57 pips (LOW = 1.16680, peak = 1.17464)
    ...
    # ✅ RÈGLE SESSION 99 : Prix référence = LOW première bougie event
    ...
    start_price = first_candle['low']  # ✅✅✅ LOW de la première bougie
...
print()
print("✅ RÈGLE SESSION 92.10 (Validée) :")
print("   - Event à 14:30 Bern → Query à 12:30:00+02:00")
print("   - Soustraire 2h à l'heure Bern")
print("   - Prix référence = LOW première bougie event")
print(f"   - Validation référence : {EXPECTED_IMPACT_REFERENCE:.1f} pips")
print()
...
for date_str in DATES_CLUSTER3:
    ...
    # Mesurer impact réel (Règle Session 92.10)
    real = measure_real_impact_SESSION9210(event_timestamp_db, date_str)
    ...
    print(f"📊 IMPACT RÉEL (Règle Session 92.10)")
    print(f"   Query timestamp      : {real['event_datetime_db_query']}")
    print(f"   First candle OPEN    : {real['first_candle_open']:.5f}")
    print(f"   First candle HIGH    : {real['first_candle_high']:.5f}")
    print(f"   First candle LOW     : {real['first_candle_low']:.5f} ← Prix référence")
    ...
    if date_str == '2025-09-11':
        ...
        print(f"      Impact attendu: {EXPECTED_IMPACT_REFERENCE:.1f} pips")
...
output_file = script_path.parent / "phase1_cluster3_results_SESSION9210_FINAL.csv"
...
print("="*80)
print("✅ PHASE 1 TERMINÉE (RÈGLE SESSION 92.10 FINALE)")
print("="*80)
