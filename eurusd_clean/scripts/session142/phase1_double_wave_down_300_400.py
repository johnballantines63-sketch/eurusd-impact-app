"""
SESSION 142 - PHASE 1 : DOUBLE_WAVE_DOWN 300-400
================================================

Objectif : Optimiser groupe DOUBLE_WAVE_DOWN 300-400 (MAE 26.66 → 22-23 pips)
...
OUTPUT_VARIANCE = OUTPUT_DIR / "phase1_variance_double_wave_down.json"
OUTPUT_COMPARISON = OUTPUT_DIR / "phase1_median_vs_mean_double_wave_down.json"
OUTPUT_DETAILED = OUTPUT_DIR / "phase1_detailed_results_double_wave_down.csv"
...
def main():
    print("=" * 80)
    print("SESSION 142 - PHASE 1 : DOUBLE_WAVE_DOWN 300-400")
    print("=" * 80)
    ...
    if comparison['gain_mae'] <= THRESHOLD_GAIN:
        ...
        print(f"   Considérer Phase 3 (Sub-grouping)")
