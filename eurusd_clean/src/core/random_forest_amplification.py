...
def extract_features_for_rf(
    ...
    ✅ AJOUT : core_score comme feature (REF-020)
    Features :
    ...
    - core_score : Score core_scores pour le core_type (nouveau)
    ...
    Args:
        ...
        core_score: Score core_scores pour le core_type (défaut: 0.0)
    ...
    features = {
        ...
        'core_score': core_score  # ✅ AJOUT : Feature core_score
    }
...
def train_rf_from_identical_clusters(
    ...
    for _, row in valid_results.iterrows():
        ...
        # ✅ AJOUT : Récupérer core_score pour ce cluster historique (REF-020)
        # Note: core_type et country doivent être identifiés depuis le cluster
        # Pour l'instant, on utilise 0.0 comme fallback (sera amélioré si nécessaire)
        core_score_hist = 0.0
        # TODO: Identifier core_type et country depuis cluster_hist pour récupérer core_score
        ...
        features = extract_features_for_rf(
            ...
            core_score=core_score_hist  # ✅ AJOUT : Feature core_score (0.0 pour historique pour l'instant)
        )
