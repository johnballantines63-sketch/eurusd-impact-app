...
def calculate_real_ttr_for_phase(
    ...
    try:
        ...
        # Normaliser les timestamps des prix
        ...
        # Si mouvement trop faible (< 3 pips), considérer comme non significatif
        if movement_pips < 3:
...
def sequence_multi_event_timeline(
    ...
    for phase_idx, group in enumerate(phase_groups):
        ...
        # Impact combiné = différence nette (vectoriel)
        ...
        phase = {
            ...
            'start': start_time,  # ✅ Aussi en format Timestamp pour calculate_real_ttr
            ...
            'impact_combined': impact_combined,  # ✅ CLÉ CORRECTE pour backtest
