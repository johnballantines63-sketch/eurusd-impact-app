...
def main():
    ...
    if px_max is None:
        print("Aucune donnée prix."); return
    ...
    ev = con.execute("""
      ...
      FROM events
      WHERE country='US'
        AND regexp_matches(lower(coalesce(event_key,'') || ' ' || coalesce(event_title,'')),
    ...
    if ev.empty:
        print("Aucun NFP trouvé avant", px_max); return
