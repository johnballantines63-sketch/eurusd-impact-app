...
from unified_chart import create_unified_prediction_chart  # ✅ AJOUT IMPORT

# === NOUVEAU : Timeline séquentielle v8.3 ===
# ⚠️ CRITIQUE : Ajouter les chemins AVANT d'importer les modules séquentiels
import sys
from pathlib import Path
    ...
    **Méthode vectorielle** :
    ...
    if len(st.session_state.selected_events) > 0:
        ...
        if len(predictions) > 1:
                ...
                if use_sequential:
                    ...
                    try:
                        with st.spinner("🔄 Calcul timeline séquentielle..."):
                            ...
                            # Fonction helper pour convertir en UTC aware
                            def to_utc_aware(ts):
                            ...
                            # 🔍 DEBUG : Afficher structure des phases
            ...
            # Si mode classique, continuer avec code existant
