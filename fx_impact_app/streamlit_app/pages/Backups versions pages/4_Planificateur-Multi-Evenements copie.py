    ...
    if cache_key in st.session_state.family_stats_cache:
        ...
        try:
            ...
            stats = {
                ...
                # TTR depuis LatencyAnalyzer peak_timing.mean_minutes (CORRECT ✅)
                'ttr_median': latency_stats.get('peak_timing', {}).get('mean_minutes', 
                    latency_stats['initial_reaction']['median_minutes'] * 3),
                'ttr_p20': latency_stats.get('peak_timing', {}).get('mean_minutes', 
                    latency_stats['initial_reaction']['median_minutes'] * 2) * 0.7,  # Estimation P20 = 70% de mean
                'ttr_p80': latency_stats.get('peak_timing', {}).get('mean_minutes', 
                    latency_stats['initial_reaction']['median_minutes'] * 3) * 1.5,  # Estimation P80 = 150% de mean
