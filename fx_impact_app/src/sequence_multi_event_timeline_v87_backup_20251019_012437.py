...
Version 8.7.0 : Implémentation de la somme vectorielle des impacts
...
print("🔄 [RELOAD] sequence_multi_event_timeline v8.7.0 - SOMME VECTORIELLE")
...
def calculate_vectorial_sum(
    ...
    impact_final = abs(impact_brut) * correction_factor
