...
def generate_candlestick_curve_multi_events(
    ...
    for minute in range(duration_minutes + 1):
        ...
        # Calculer prix cible pour cette minute (somme contributions de tous événements)
        ...
        for pred in predictions:
            ...
            # Phase mouvement
                ...
                contribution = price_change * sigmoid_progress
            ...
            # Phase retracement
                ...
                contribution = price_change * (1 - 0.382 * exp_progress)
