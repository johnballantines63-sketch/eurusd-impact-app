#!/usr/bin/env python3
"""
Pipeline Complet Session 75 - Version Intégrée
1. Scanner stratifié
2. Création dataset
3. Analyse ML
Tout en un seul script pour efficacité
"""
...
print("\n" + "="*80)
print("PIPELINE COMPLET SESSION 75 - AMÉLIORATION DATASET")
print("="*80 + "\n")
...
# Export Phase 1
output_movements = fx_impact_app_path / "data" / "movements_strong_session75_stratified.csv"
...
# Export Phase 2
output_dataset = fx_impact_app_path / "data" / "dataset_complete_session75.csv"
...
if len(df_ml) < 10:
    ...
    # Export résultats ML
    output_regression = fx_impact_app_path / "data" / "regression_results_session75.txt"
    with open(output_regression, 'w') as f:
        f.write("REGRESSION LINÉAIRE - SESSION 75\n")
        f.write("="*80 + "\n\n")
    ...
    print(f"\n   💾 Résultats exportés : regression_results_session75.txt")
...
print(f"\n{'='*80}")
print(f"✅ PIPELINE SESSION 75 COMPLÉTÉ")
print(f"{'='*80}\n")
...
print(f"\n📂 Fichiers créés :")
print(f"   1. movements_strong_session75_stratified.csv")
print(f"   2. dataset_complete_session75.csv")
print(f"   3. regression_results_session75.txt")

print(f"\n🎯 Prochaines étapes :")
print(f"   1. Analyser résultats (R², MAE, clusters)")
print(f"   2. Comparer Session 74 vs Session 75")
print(f"   3. Décider : Créer formulas_validated_v2.1.py ?")
