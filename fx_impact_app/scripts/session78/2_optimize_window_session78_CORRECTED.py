#!/usr/bin/env python3
"""
OPTIMISATION FENÊTRE TEMPORELLE - SESSION 78 CORRIGÉE
=====================================================
...
print("\n" + "="*70)
print("OPTIMISATION FENÊTRE TEMPORELLE - SESSION 78 CORRIGÉE")
print("="*70 + "\n")
...
OUTPUT_PATH = SCRIPT_DIR / "optimize_window_results_session78_corrected.txt"
with open(OUTPUT_PATH, 'w') as f:
    f.write("OPTIMISATION FENÊTRE TEMPORELLE - SESSION 78 CORRIGÉE\n")
    f.write("="*70 + "\n\n")
