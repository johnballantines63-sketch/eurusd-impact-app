#!/bin/bash
# Création complète du fichier latency_analyzer.py (version corrigée ILIKE)

cd /Users/andrevalentin/Projects/eurusd_news_impact_calculator

rm -f fx_impact_app/src/latency_analyzer.py

cat > fx_impact_app/src/latency_analyzer.py << 'ENDOFPYTHON'
"""
...
echo "✅ Fichier latency_analyzer.py créé (version ILIKE)"
echo ""
